...
/**
* This panel is the basic pane, inside which other panes are placed. Also modified to get ship names
...
public class MainPaneFX {
    ...
    */
    MainPaneFX(double CANVAS_WIDTH, double CANVAS_HEIGHT) {
        ...
        addButton.setOnAction(event -> {
            try {
                ...
                if (!tonsField.getText().equals("")) tons = Integer.parseInt(tonsField.getText());
                if (!pxField.getText().equals("")) pax = Integer.parseInt(pxField.getText());
                if (!gunsField.getText().equals("")) guns = Integer.parseInt(gunsField.getText());
                if (!acField.getText().equals("")) ac = Integer.parseInt(acField.getText());
                if (!torpField.getText().equals("")) torps = Integer.parseInt(torpField.getText());
    ...
    private void writeFile() {
        ...
        if (file != null) ships.writeFile(file);
    }
