...
/**
 * Contains an ArrayList of objects that inherit from the Abstract class ships
 * which keeps tracks of the type of ships, gets ship descriptions including warship descriptions, 
 * and writes information to a CSV file.
 * All methods defined on an interface are public and abstract by definition.
 * @author Josue Ponce
 * @version 1.0
 */
