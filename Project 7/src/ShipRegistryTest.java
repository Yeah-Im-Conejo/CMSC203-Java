...
/**
 * ShipRegistryTest ensures that all the methods in ShipRegistry.Java are implemented correctly.
 * Additionally, makes sure that the read and write file methods work as intended.
 * @author Josue Ponce
 * @version 1.0
 */
public class ShipRegistryTest {
	...
	public void testAddShip() {
		...
		assertEquals(20,((WarShip) shipList.get(7)).getNumTorpedoes());
	}
